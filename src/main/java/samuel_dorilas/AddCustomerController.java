...
public class AddCustomerController implements Initializable {
    ...
    private final String createdBy = Login.userNameStored;
    ...
    @FXML private void save(ActionEvent e){
        ...
        try(Connection conn = DriverManager.getConnection(Login.url,Login.user,Login.pass);){
            ...
            int rs1 =  stmt.executeUpdate("INSERT INTO customer VALUES (" + "'" + CID + "', '" + 
                    custNameF.getText() + "', '" + addressId + "', '" + active + "', '" + createDate + "', '" + 
                    createdBy + "', '" + lastUpdate + "', '" + lastUpdateBy + "')");
            
            int rs2 =  stmt.executeUpdate("INSERT INTO address VALUES (" + "'" + addressId + "', '" + custAddressF.getText() +
                    "', '" + address2 + "', '" + cityId + "', '" + custPostalF.getText() + "', '" + custPhoneF.getText() + "', '" +
                    createDate + "', '" + createdBy + "', '" + lastUpdate + "', '" + lastUpdateBy + "')");
            
            int rs3 =  stmt.executeUpdate("INSERT INTO city VALUES (" + "'" + cityId + "', '" + custCityF.getText() + "', '" +
                    countryId + "', '" + createDate + "', '" + createdBy + "', '" + lastUpdate + "', '" + lastUpdateBy + "')");
            
            int rs4 =  stmt.executeUpdate("INSERT INTO country VALUES (" + "'" + countryId + "', '" + custCountryF.getText() + 
                    "', '" + createDate + "', '" + createdBy + "', '" + lastUpdate + "', '" + lastUpdateBy + "')");
        ...
        customer = new Customer(CID, custNameF.getText(), active, createDate, createdBy, lastUpdate, 
         ...
         Customer.custList.add(customer);
