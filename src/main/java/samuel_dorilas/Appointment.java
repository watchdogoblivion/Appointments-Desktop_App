...
public class Appointment {
    ...
    static int aptIndex;
    static Label aptDetails = new Label();
    static ObservableList<Appointment> aptList =
                  FXCollections.observableArrayList();
    static ObservableList<Appointment> inList =
                  FXCollections.observableArrayList();
    static ObservableList<Appointment> cancelList =
                  FXCollections.observableArrayList();
    static ObservableList<Appointment> absentList =
                  FXCollections.observableArrayList();
